-- 085_pc_builder.sql
-- Armador PC: borradores + items con RLS y trazabilidad hacia quotes
...
CREATE TABLE IF NOT EXISTS pc_build_items (
  ...
  slot_key             TEXT NOT NULL CHECK (slot_key IN ('cpu', 'motherboard', 'ram', 'storage', 'gpu', 'psu', 'case', 'monitor')),
